...
# หน้าเว็บเรียกทุก 45 วินาที ตั้ง TTL ให้สั้นกว่านั้นเพื่อให้แต่ละรอบได้ข้อมูลใหม่จริง
# แต่ยังยาวพอจะกัน yfinance โดนยิงซ้ำเมื่อมีหลายแท็บ/หลายผู้ใช้เรียกเหลื่อมกัน
CACHE_TTL_SEC = 30
